...
/**
 * Trimmed replacement for TODD's NotificationService, copied from
 * web-products/network's NetworkNotificationService - same `show(header,
...
export class PulseNotificationService {
  private nextId = 1;
